...
Kemistry jest kolekcją aplikacji chemicznych dla KDE. Zawiera
aplikacje:

- KMolCalc - kalkulator wagi molowej,
- KemBabel - program do konwersji między chemicznymi formatami
...
Program do konwersji między chemicznymi formatami plików, oparty na
Open Babel.
